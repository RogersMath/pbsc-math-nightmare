...
const config = {
    ...
    characterType: null // Will be set by character selector
};
...
function initCharacterSelector() {
    ...
    buttons.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            config.characterType = character;
...
function init() {
    ...
    document.getElementById('character-select-btn').addEventListener('click', backToCharacterSelect);
    document.getElementById('quit-btn').addEventListener('click', backToCharacterSelect);
